...
const MODUL = {
  ...
  slug: "fang",
  untertitel: "FANG.Willkommen.Untertitel",
  einleitung: "FANG.Willkommen.Einleitung",
  punkte: [
    "FANG.Willkommen.Punkt1",
    "FANG.Willkommen.Punkt2",
    "FANG.Willkommen.Punkt3"
  ],
  start: "FANG.Willkommen.Start"
};
...
export async function willkommenZeigen() {
    ...
    <div class="ninjo-willkommen">
      ...
      <a class="ninjo-willkommen-forge" href="${forgeAdresse()}" target="_blank" rel="noopener">
        ...
        <span class="ninjo-willkommen-forge-text">
          ...
          <span class="ninjo-willkommen-forge-zeile">${text("FANG.Willkommen.ForgeZeile")}</span>
        </span>
  ...
  const antwort = await foundry.applications.api.DialogV2.wait({
    ...
    buttons: [
      {
        action: "nie",
        label: "FANG.Willkommen.Nie",
        icon: "fa-solid fa-check",
        default: true
      },
      {
        action: "spaeter",
        label: "FANG.Willkommen.Spaeter",
