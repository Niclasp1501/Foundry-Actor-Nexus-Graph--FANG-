...
- [ ] **1.1.2 Affiliation zones / Zugehoerigkeitsfelder:** Visual zones (e.g. city/region/organization) to group characters / Visuelle Bereiche (z. B. Stadt/Region/Organisation), in denen Charaktere zugeordnet werden koennen.
